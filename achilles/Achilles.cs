...
namespace achilles {
    public class Achilles {
        ...
        #region HTTP Methods     (Public, Static, Stateless)
        ...
        #region HTTP Methods     (Public, Branching, Stateless) 
        ...
        #region HTTP Methods     (Public, Chaining, Stateful) 
        ...
        #region Non-HTTP Methods (Public, Chaining, Stateful) 
        ...
        #region HTTP Methods     (Private, Non-Chaining, Stateful) 
